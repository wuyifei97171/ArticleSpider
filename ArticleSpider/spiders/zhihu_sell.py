...
class ZhihuSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # brower.find_element_by_css_selector('.SignFlow-accountInput Input-wrapper input[name="username"]') \
        #     .send_keys("15618911316")
        brower.find_element_by_xpath('/html/body/div[1]/div/main/div/div/div/div[2]/div[1]/form/div[1]/div[2]/div[1]/input')\
            .send_keys("15618911316")
        brower.find_element_by_css_selector(
            'div.SignFlowInput:nth-child(1) > div:nth-child(1) > input:nth-child(1)') \
            .send_keys("123123123")
        # brower.find_element_by_xpath('/html/body/div[1]/div/main/div/div/div/div[2]/div[1]/form/div[2]/div/div[2]')\
        #     .send_keys("123123123")
